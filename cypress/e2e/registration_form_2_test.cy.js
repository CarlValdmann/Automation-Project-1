...
// -- means it doesnt work and im not able to detect the problem in the code or UI.
// ** means it's either done or it works
...
describe('Section 1: Functional tests', () => {
    ...
    it.only('User cannot submit the form with mandatory fields empty', ()=>{
        // May 6, 2024
        cy.get('#username').type('CarlValdmann')
        cy.get('#email').type('carljohann.valdmann@gmail.com')
        cy.get('[data-cy="name"]').type('Carl-Johann')
...
describe('Section 2: Visual tests', () => {
    ...
    it('Navigation, check the second link', () => {
        cy.get('nav').children().should('have.length', 2)
        cy.get('nav').siblings('h1').should('have.text', 'Registration form number 2')
        cy.get('nav').children().eq(0).should('be.visible')
            .and('have.attr', 'href', 'registration_form_1.html')
    ...
    it('Checking/verifying check boxes', () => {
        ...
        // Selecting one or more checkboxes is possible.
